...
window.quizData = window.quizData.concat([
    ...
    },
    {
        ...
        options: ["Mandi, Kullu, Lahaul-Spiti, Kinnaur, Rampur, Bharmour (मंडी, कुल्लू, लाहौल-स्पीति, किन्नौर, रामपुर, भरमौर)", "Only Mandi (केवल मंडी)", "Shimla and Solan (शिमला और सोलन)", "Kangra and Chamba (कांगड़ा और चंबा)"],
        answer: 0,
        explanation: "It is one of the geographically largest constituencies, covering tribal areas and central districts."
    },
    {
        id: 274,
    ...
    },
    {
        ...
        options: ["Indian National Congress (भारतीय राष्ट्रीय कांग्रेस)", "Janata Party (जनता पार्टी)", "BJP (बीजेपी)", "Communist Party (कम्युनिस्ट पार्टी)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Deodar (Cedar) (देवदार)", "Pine (चीड़)", "Oak (बलूत)", "Peepal (पीपल)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Lahaul-Spiti (लाहौल-स्पीति)", "Kinnaur (किन्नौर)", "Bilaspur (बिलासपुर)", "Una (ऊना)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Block Level (Intermediate) (ब्लॉक स्तर - मध्यवर्ती)", "Village Level (ग्राम स्तर)", "District Level (जिला स्तर)", "State Level (राज्य स्तर)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Shimla (1851) (शिमला)", "Dharamshala (धर्मशाला)", "Mandi (मंडी)", "Nahan (नाहन)"],
        answer: 0,
    ...
    {
        id: 323,
        questionEn: "The 'Lokayukta' investigates cases of:",
        questionHi: "'लोकायुक्त' किसके मामलों की जांच करता है?",
        options: ["Corruption against public servants (लोक सेवकों के खिलाफ भ्रष्टाचार)", "Murder (हत्या)", "Theft (चोरी)", "Land disputes (भूमि विवाद)"],
        answer: 0,
        explanation: "Lokayukta deals with corruption allegations against ministers and public servants."
    },
    {
        id: 324,
    ...
    {
        id: 328,
        questionEn: "The 'Leader of Opposition' gets the rank of:",
        questionHi: "'विपक्ष के नेता' को किसका दर्जा मिलता है?",
        options: ["Cabinet Minister (कैबिनेट मंत्री)", "State Minister (राज्य मंत्री)", "Deputy Minister (उप मंत्री)", "MLA (विधायक)"],
        answer: 0,
        explanation: "The Leader of Opposition holds the rank of a Cabinet Minister."
    },
    {
        id: 329,
    ...
    {
        id: 333,
        questionEn: "The 'HP Tenancy and Land Reforms Act' was enacted in:",
        questionHi: "'हि.प्र. काश्तकारी और भूमि सुधार अधिनियम' कब अधिनियमित किया गया था?",
        options: ["1972 (1972)", "1954 (1954)", "1960 (1960)", "1980 (1980)"],
        answer: 0,
        explanation: "A major land reform act passed in 1972."
    },
    {
        id: 334,
    ...
    {
        id: 335,
        questionEn: "The 'High Court' judges retire at the age of:",
        questionHi: "'उच्च न्यायालय' के न्यायाधीश किस उम्र में सेवानिवृत्त होते हैं?",
        options: ["62 years (62 वर्ष)", "65 years (65 वर्ष)", "60 years (60 वर्ष)", "70 years (70 वर्ष)"],
        answer: 0,
        explanation: "The retirement age is 62."
    },
    {
        id: 336,
    ...
    {
        id: 340,
        questionEn: "Which political party won the 1977 assembly elections in HP?",
        questionHi: "1977 के विधानसभा चुनावों में हि.प्र. में किस राजनीतिक दल ने जीत हासिल की थी?",
        options: ["Janata Party (जनता पार्टी)", "Congress (कांग्रेस)", "BJP (बीजेपी)", "Lok Dal (लोक दल)"],
        answer: 0,
        explanation: "The Janata Party won the 1977 elections, forming the first non-Congress government."
    },
    {
        id: 341,
    ...
    },
    {
        ...
        options: ["Mandi (Jogindernagar) (मंडी - जोगिंदरनगर)", "Shimla (शिमला)", "Kangra (कांगड़ा)", "Solan (सोलन)"],
        answer: 0,
        explanation: "Revenue Training Institute is at Jogindernagar."
    },
    {
        id: 358,
    ...
    {
        id: 360,
        questionEn: "The 'State Bird' Western Tragopan is locally called:",
        questionHi: "'राज्य पक्षी' पश्चिमी ट्रैगोपेन को स्थानीय रूप से क्या कहा जाता है?",
        options: ["Jujurana (जुजुराना)", "Monal (मोनाल)", "Cheer (चीर)", "Kol (कोल)"],
        answer: 0,
        explanation: "It is called Jujurana (King of Birds)."
    }
]);
