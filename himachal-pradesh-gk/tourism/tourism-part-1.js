...
window.quizData.push(
    ...
    },
    {
        ...
        options: ["Unforgettable Himachal (अविस्मरणीय हिमाचल)", "Magical Himachal (जादुई हिमाचल)", "Incredible Himachal (अतुल्य हिमाचल)", "Dev Bhoomi Himachal (देवभूमि हिमाचल)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Chamba (चंबा)", "Shimla (शिमला)", "Kullu (कुल्लू)", "Kangra (कांगड़ा)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Narkanda (नारकंडा)", "Solang Valley (सोलंग घाटी)", "Kufri (कुफरी)", "Khajjiar (खज्जियार)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Kullu (कुल्लू)", "Shimla (शिमला)", "Lahaul-Spiti (लाहौल-स्पीति)", "Kinnaur (किन्नौर)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Lord Dalhousie (लॉर्ड डलहौजी)", "Major Kennedy (मेजर केनेडी)", "Lt. Rose (लेफ्टिनेंट रोज़)", "Lord Amherst (लॉर्ड एमहर्स्ट)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Palampur (पालमपुर)", "Solan (सोलन)", "Shimla (शिमला)", "Manali (मनाली)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Paonta Sahib (पांवटा साहिब)", "Chamba (चंबा)", "Andretta (आंद्रेता)", "Naggar (नग्गर)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Sangla Valley (सांगला घाटी)", "Kangra Valley (कांगड़ा घाटी)", "Chamba Valley (चंबा घाटी)", "Kullu Valley (कुल्लू घाटी)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Shimla (शिमला)", "Dharamshala (धर्मशाला)", "Dalhousie (डलहौजी)", "Manali (मनाली)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Barnes Court (बार्न्स कोर्ट)", "Gorton Castle (गॉर्टन कैसल)", "Viceregal Lodge (वायसराय लॉज)", "Peterhoff (पीटरहॉफ)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Yak (याक)", "Musk Deer (कस्तूरी मृग)", "Snow Leopard (हिम तेंदुआ)", "Himalayan Monal (हिमालयन मोनाल)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["None of the above (इनमें से कोई नहीं)", "Raja of Mandi & British Queen (मंडी के राजा और ब्रिटिश रानी)", "Maharaja of Kapurthala & Governor's Wife (कपूरथला के महाराजा और गवर्नर की पत्नी)", "Maharaja of Patiala & Viceroy's Daughter (पटियाला के महाराजा और वायसराय की बेटी)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Summer Hill (समर हिल)", "Jakhu Hill (जाखू हिल)", "Tara Devi (तारा देवी)", "Prospect Hill (प्रोस्पेक्ट हिल)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Town Hall (टाउन हॉल)", "Christ Church (क्राइस्ट चर्च)", "Gaiety Theatre (गेटी थिएटर)", "Viceregal Lodge (वायसराय लॉज)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Dharamshala (धर्मशाला)", "Chaura Maidan, Shimla (चौड़ा मैदान, शिमला)", "Kullu (कुल्लू)", "Annadale, Shimla (अन्नाडेल, शिमला)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["1500 m", "2500 m", "1800 m", "2206 m"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Queen Victoria (महारानी विक्टोरिया)", "Lord Dufferin (लॉर्ड डफरिन)", "Lord Lytton (लॉर्ड लिटन)", "Lord Curzon (लॉर्ड कर्जन)"],
        answer: 2,
    ...
    // Hill Stations - Manali & Kullu
    {
        ...
        options: ["Sage Vyas (ऋषि व्यास)", "Sage Parashar (ऋषि पराशर)", "Sage Vashisht (ऋषि वशिष्ठ)", "Sage Manu (ऋषि मनु)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Ghatotkach Temple (घटोत्कच मंदिर)", "Hadimba Devi Temple (हडिम्बा देवी मंदिर)", "Manu Temple (मनु मंदिर)", "Vashisht Temple (वशिष्ठ मंदिर)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Kasauli (कसौली)", "Shimla (शिमला)", "Manali (मनाली)", "Dalhousie (डलहौजी)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Ice Skating (आइस स्केटिंग)", "Curling (कर्लिंग)", "Ice Hockey (आइस हॉकी)", "Skiing (स्कीइंग)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Vashisht (वशिष्ठ)", "Jeori (ज्यूरी)", "Manikaran (मणिकरण)", "Tattapani (तत्तापानी)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Sangla Valley (सांगला घाटी)", "Chamba Valley (चंबा घाटी)", "Lahaul & Spiti Valley (लाहौल और स्पीति घाटी)", "Kangra Valley (कांगड़ा घाटी)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Shipki La (शिपकी ला)", "Baralacha La (बारालाचा ला)", "Kunzum Pass (कुंजुम दर्रा)", "Rohtang Pass (रोहतांग दर्रा)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Chamba (चंबा)", "Kullu (कुल्लू)", "Mandi (मंडी)", "Suket (सुकेत)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Raja Sansar Chand (राजा संसार चंद)", "Raja Sidh Singh (राजा सिद्ध सिंह)", "Raja Bahadur Singh (राजा बहादुर सिंह)", "Raja Jagat Singh (राजा जगत सिंह)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Dharamshala (धर्मशाला)", "Shimla (शिमला)", "Andretta (आंद्रेता)", "Naggar (नग्गर)"],
        answer: 3,
    ...
    // Hill Stations - Dharamshala & Kangra
    {
        ...
        options: ["McLeodganj (मैक्लोडगंज)", "Dari (दारी)", "Sidhbari (सिद्धबाड़ी)", "Yol (योल)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Una (ऊना)", "Hamirpur (हमीरपुर)", "Dharamshala (धर्मशाला)", "Shimla (शिमला)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Rewalsar (रिवालसर)", "Leh (लेह)", "Spiti (स्पीति)", "McLeodganj (मैक्लोडगंज)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Lord Curzon (लॉर्ड कर्जन)", "Lord Elgin (लॉर्ड एल्गिन)", "Lord Mayo (लॉर्ड मेयो)", "Lord Dalhousie (लॉर्ड डलहौजी)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Renuka Lake (रेणुका झील)", "Prashar Lake (पराशर झील)", "Rewalsar Lake (रिवालसर झील)", "Dal Lake (डल झील)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Mandi (मंडी)", "Shimla (शिमला)", "Dharamshala (धर्मशाला)", "Hamirpur (हमीरपुर)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Dalhousie (डलहौजी)", "Chamba (चंबा)", "Manali (मनाली)", "Dharamshala (धर्मशाला)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Tabo Monastery (ताबो मठ)", "Namgyal Monastery (नामग्याल मठ)", "Kardang Monastery (करदांग मठ)", "Key Monastery (की मठ)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Coffee Plantations (कॉफी बागान)", "Orange Orchards (संतरे के बाग)", "Tea Gardens (चाय बागान)", "Apple Orchards (सेब के बाग)"],
        answer: 2,
    ...
    // Hill Stations - Dalhousie & Chamba
    {
        ...
        options: ["Raja of Chamba (चंबा के राजा)", "Lord Curzon (लॉर्ड कर्जन)", "Lord Napier (लॉर्ड नेपियर)", "Lord Dalhousie (लॉर्ड डलहौजी)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Manali (मनाली)", "Kasauli (कसौली)", "Dalhousie (डलहौजी)", "Shimla (शिमला)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Sangla (सांगला)", "Khajjiar (खज्जियार)", "Kufri (कुफरी)", "Solang (सोलंग)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Chenab (चिनाब)", "Satluj (सतलुज)", "Beas (ब्यास)", "Ravi (रावी)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Shimla (शिमला)", "Kangra (कांगड़ा)", "Chamba (चंबा)", "Mandi (मंडी)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Mandi (मंडी)", "Dharamshala (धर्मशाला)", "Shimla (शिमला)", "Chamba (चंबा)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Sirmaur (सिरमौर)", "Chamba (चंबा)", "Kullu (कुल्लू)", "Shimla (शिमला)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Dhauladhar (धौलाधार)", "All of the above (उपरोक्त सभी)", "Manimahesh Kailash (मणिमहेश कैलाश)", "Pir Panjal (पीर पंजाल)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Mahatma Gandhi (महात्मा गांधी)", "Lala Lajpat Rai (लाला लाजपत राय)", "Subhash Chandra Bose (सुभाष चंद्र बोस)", "Bhagat Singh (भगत सिंह)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Kasauli (कसौली)", "Dalhousie (डलहौजी)", "Bharmour (भरमौर)", "Khajjiar (खज्जियार)"],
        answer: 0,
    ...
    // Hill Stations - Solan & Sirmaur
    {
        ...
        options: ["NIT (एनआईटी)", "IIM (आईआईएम)", "IIT (आईआईटी)", "Central Research Institute (CRI) (केंद्रीय अनुसंधान संस्थान)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Chail (चायल)", "Solan (सोलन)", "Kasauli (कसौली)", "Shimla (शिमला)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Railway Station (रेलवे स्टेशन)", "Cricket Ground (क्रिकेट मैदान)", "Dam (बांध)", "Post Office (डाकघर)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["British (अंग्रेज)", "Raja of Bushahr (बुशहर के राजा)", "Maharaja of Patiala (पटियाला के महाराजा)", "Raja of Sirmaur (सिरमौर के राजा)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Kotgarh (कोटगढ़)", "Kullu (कुल्लू)", "Solan (सोलन)", "Rajgarh (Sirmaur) (राजगढ़, सिरमौर)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Mandi (मंडी)", "Una (ऊना)", "Shimla (शिमला)", "Solan (सोलन)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Bilaspur (बिलासपुर)", "Chamba (चंबा)", "Sirmaur (सिरमौर)", "Mandi (मंडी)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Highest Peak (सबसे ऊंची चोटी)", "Oldest Temple (सबसे पुराना मंदिर)", "Largest Lake (सबसे बड़ी झील)", "Longest Railway Tunnel (सबसे लंबी रेलवे सुरंग)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Bata (बाटा)", "Tons (टोंस)", "Giri (गिरी)", "Yamuna (यमुना)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Una (ऊना)", "Bilaspur (बिलासपुर)", "Sirmaur (सिरमौर)", "Solan (सोलन)"],
        answer: 2,
    ...
    // Misc Overview & Facts
    {
        ...
        options: ["Polo (पोलो)", "Hockey (हॉकी)", "Golf (गोल्फ)", "Cricket (क्रिकेट)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Kaza (काजा)", "Langza (लांगजा)", "Kibber (किब्बर)", "Hikkim (हिक्किम)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Hot Springs (गर्म पानी के झरने)", "Apples (सेब)", "Monastery (मठ)", "Ancient Democracy (प्राचीन लोकतंत्र)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Kinnaur (किन्नौर)", "Chamba (चंबा)", "Lahaul (लाहौल)", "Spiti (स्पीति)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Skating (स्केटिंग)", "Rafting (राफ्टिंग)", "Paragliding (पैराग्लाइडिंग)", "Skiing (स्कीइंग)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Gramphu (ग्राम्फू)", "Koksar (कोकसर)", "Keylong (केलंग)", "Rohtang Pass (रोहतांग दर्रा)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Rampur (रामपुर)", "Solan (सोलन)", "Shimla (शिमला)", "Nahan (नाहन)"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Shimla (शिमला)", "Chamba (चंबा)", "Kullu (कुल्लू)", "Mandi (मंडी)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Nahan (नाहन)", "Bilaspur (बिलासपुर)", "Sujanpur (सुजानपुर)", "Chamba (चंबा)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Masroor Rock Cut Temple (मसरूर रॉक कट मंदिर)", "Dhankar Monastery (धनकर मठ)", "Key Monastery (की मठ)", "Tabo Monastery (ताबो मठ)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Jwalaji (ज्वालाजी)", "Hidimba Temple (हडिम्बा मंदिर)", "Masroor Rock Cut Temple (मसरूर रॉक कट मंदिर)", "Baijnath (बैजनाथ)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Monasteries (मठ)", "Hot Water Springs (गर्म पानी के झरने)", "Cold Desert (शीत मरुस्थल)", "Skiing (स्कीइंग)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Solan (सोलन)", "Dharamshala (धर्मशाला)", "Shimla (शिमला)", "Chail (चायल)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Kufri (कुफरी)", "Dharamshala (धर्मशाला)", "Manali (मनाली)", "Shimla (शिमला)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Kullu (कुल्लू)", "Kinnaur (किन्नौर)", "Spiti (स्पीति)", "Lahaul (लाहौल)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Mandi (मंडी)", "Sirmaur (सिरमौर)", "Shimla (शिमला)", "Solan (सोलन)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Vashisht Rishi (वशिष्ठ ऋषि)", "Hadimba Devi (हडिम्बा देवी)", "Ghatotkach (घटोत्कच)", "Manu Rishi (मनु ऋषि)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Solan (सोलन)", "Dharamshala (धर्मशाला)", "Manali (मनाली)", "Shimla (शिमला)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Shipki La (शिपकी ला)", "Kunzum (कुंजुम)", "Rohtang (रोहतांग)", "Baralacha La (बारालाचा ला)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Kullu (कुल्लू)", "Lahaul & Spiti (लाहौल और स्पीति)", "Chamba (चंबा)", "Kinnaur (किन्नौर)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Shimla (शिमला)", "Mandi (मंडी)", "Kinnaur (किन्नौर)", "Lahaul & Spiti (लाहौल और स्पीति)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Pandoh (पंडोह)", "Chamera (चमेरा)", "Pong Dam (पोंग बांध)", "Gobind Sagar (गोबिंद सागर)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Jakhu Hill, Shimla (जाखू हिल, शिमला)", "Observatory Hill, Shimla (ऑब्जर्वेटरी हिल, शिमला)", "Prospect Hill, Shimla (प्रोस्पेक्ट हिल, शिमला)", "Summer Hill, Shimla (समर हिल, शिमला)"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Subathu (सुबाथू)", "Dagshai (दगशाई)", "Yol (योल)", "Shimla (शिमला)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Y.S. Parmar (वाई.एस. परमार)", "None (कोई नहीं)", "Jawaharlal Nehru (जवाहरलाल नेहरू)", "It is a general nickname (यह एक सामान्य उपनाम है)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["All of the above (उपरोक्त सभी)", "Hotel Peterhoff (होटल पीटरहॉफ)", "The Castle, Naggar (द कैसल, नग्गर)", "Hotel Holiday Home (होटल हॉलिडे होम)"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Kullu (कुल्लू)", "Lahaul (लाहौल)", "Spiti (स्पीति)", "Kinnaur (किन्नौर)"],
        answer: 2,
